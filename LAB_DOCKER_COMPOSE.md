...
```
1.docker run เป็นคำสั่งพื้นฐานในการสร้างและเริ่มต้นการทำงานของคอนเทนเนอร์ใหม่จากอิมเมจที่ระบุ
2.-d คือการสั่งให้คอนเทนเนอร์ทำงานในพื้นหลัง (Background) เพื่อให้หน้าจอคำสั่งยังสามารถใช้งานต่อไปได้
3.--name my-nginx เป็นการกำหนดชื่อเฉพาะให้แก่คอนเทนเนอร์ว่า my-nginx เพื่อความสะดวกในการบริหารจัดการแทนการใช้รหัสตัวเลขสุ่ม
4.-p 8080:80 เป็นการเชื่อมโยงพอร์ต (Port Mapping) โดยกำหนดให้พอร์ต 8080 ของเครื่องโฮสต์ ส่งข้อมูลไปยังพอร์ต 80 ภายในคอนเทนเนอร์
5.nginx:alpine คือการระบุชื่ออิมเมจที่จะนำมาใช้งาน โดยในที่นี้คือ Nginx รุ่น Alpine Linux ซึ่งมีขนาดเล็กและประหยัดทรัพยากร
